...
target_dir = "#{recording_dir}/process/slides-enhanced/#{meeting_id}"
if not FileTest.directory?(target_dir)
	logger = Logger.new("/var/log/bigbluebutton/slides-enhanced/process-#{meeting_id}.log", 'daily' )
  ...
  presentations.each do |pres|
	...
	process_done = File.new("#{recording_dir}/status/processed/#{meeting_id}-slides-enhanced.done", "w")
